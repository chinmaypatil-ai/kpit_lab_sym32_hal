...
int main(void)
{
  ...
  MX_USART2_UART_Init();
  MX_RTC_Init();
  RTC_HandleTypeDef hrtc;  // Global variable, initialized in MX_RTC_Init()

  /* USER CODE BEGIN 2 */
  // === Set current time: 10:59:50 ===
   ...
   // === Configure Alarm A for 11:00:00 ===
   RTC_AlarmTypeDef sAlarm = {0};
   sAlarm.AlarmTime.Hours = 11;
   sAlarm.AlarmTime.Minutes = 24;
   sAlarm.AlarmTime.Seconds = 30;
   sAlarm.AlarmMask = RTC_ALARMMASK_DATEWEEKDAY;  // Ignore date → triggers daily
...
void HAL_RTC_AlarmAEventCallback(RTC_HandleTypeDef *hrtc)
{
  ...
  snprintf(msg, sizeof(msg), ">>> Alarm Triggered! Time: %02d:%02d:%02d\r\n",
