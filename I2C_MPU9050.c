...
void MPU9250_INIT(void){
 ...
 {
	 uint8_t Rec_Data[6];
	 HAL_I2C_Mem_Read(&hi2c1,MPU9250_ADDR,ACCEL_XOUT_H_ADDR,I2C_MEMADD_SIZE_8BIT,Rec_Data,I2C_MEMADD_SIZE_8BIT,1000);
...
//
	 ...
	 int len = snprintf(buffer, sizeof(buffer), "Ax = %d.%02d\r\n", Ax_int / 100, Ax_int % 100);
